# app.py (updated - Aadhaar front/back detection uses max-matched-fields logic)
import os
import re
import json
import time
...
IMAGES_DIR = os.path.join(PROJECT_ROOT, "images4")
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "outputday5")
